...
class ItemControllerTest {
    ...
    public void testSuccessfulladdItem() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/items/new")
                ...
                .andReturn();
        JSONAssert.assertEquals(objectMapper.writeValueAsString(item1), mvcResult.getResponse().getContentAsString(), false);
    }
    ...
    public void getAllItems() throws Exception {
        ...
        List<ItemDto> expected = ItemDto.from(items);
    ...
    public void getOneItem() throws Exception{
        ...
        ItemDto expected = ItemDto.from(item1);
        JSONAssert.assertEquals(objectMapper.writeValueAsString(expected), result.getResponse().getContentAsString(), false);
    }

    @Test
    public void getOneItemIfNotExists() throws Exception{
        given(itemService.getItem(1L)).willThrow(new NotFoundException(Item.class, "id", String.valueOf(1L)));
    ...
    public void deleteCategoryIfNotExists() throws Exception{
        doThrow(new NotFoundException(Category.class, "id", String.valueOf(111L))).when(itemService).deleteItem(111L);
    ...
    public void updateItemIfExists() throws Exception{
        ...
        MvcResult result = mockMvc.perform(put("/items/update")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(itemDto))).andReturn();
    ...
    public void updateItemIfNotExists() throws Exception{
        doThrow(new NotFoundException(Item.class, "id", String.valueOf(111L))).when(itemService).updateItem(itemDto);
        mockMvc.perform(put("/items/update")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(itemDto))).andExpect(status().isNotFound());
    }
